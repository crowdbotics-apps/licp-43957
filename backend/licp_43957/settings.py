"""
Django settings for licp_43957 project.
...
WSGI_APPLICATION = 'licp_43957.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "licp_43957 API",
    "DESCRIPTION": "API documentation for licp_43957 App",
    "VERSION": "v1",
}
